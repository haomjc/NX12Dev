...
int rollaway::apply_cb()
{
    ...
    try
    {
		...
		NXOpen::Arc *arc1;
		NXOpen::Arc *arc2;
		arc1 = workPart->Curves()->CreateArc(center1, nXMatrix1, linear_S, 0.0, (360.0 * DEGRA));
		arc2 = workPart->Curves()->CreateArc(center1, nXMatrix1, linear_L, 0.0, (360.0 * DEGRA));
		...
		NXOpen::Features::DatumCsys *datumCsys2(dynamic_cast<NXOpen::Features::DatumCsys *>(feature2));
		...
		NXOpen::Point3d dimOrigin1(0.0, 4.3151169461418482, 0.0);
		NXOpen::Expression *nullNXOpen_Expression(NULL);
		NXOpen::SketchDimensionalConstraint *sketchDimensionalConstraint1;
		sketchDimensionalConstraint1 = theSession->ActiveSketch()->CreateDiameterDimension(dimObject1_1, dimOrigin1, nullNXOpen_Expression, NXOpen::Sketch::DimensionOptionCreateAsAutomatic);
		...
		NXOpen::Unit *unit11;
		unit11 = extrudeBuilder1->Draft()->FrontDraftAngle()->Units();

		NXOpen::Expression *expression13;
		expression13 = workPart->Expressions()->CreateSystemExpressionWithUnits("2.00", unit1);
		...
		extrudeBuilder1->Offset()->EndOffset()->SetRightHandSide(s_linear_H2.str());
		...
		curves1[0] = arc2;
		curves1[1] = arc1;
		NXOpen::Point3d seedPoint1(linear_S/2, linear_L/2, 0.0);
		...
		feature12 = extrudeBuilder1->CommitFeature();

		NXOpen::Expression *expression6(extrudeBuilder1->Limits()->StartExtend()->Value());
		NXOpen::Expression *expression7(extrudeBuilder1->Limits()->EndExtend()->Value());
		...
		//NXOpen::Section *section1;
		//section1 = workPart->Sections()->CreateSection(0.001, 0.001, 0.05);
